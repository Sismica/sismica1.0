      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Bloopets Admin!</span></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-users"></i> Comunidades <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="/welcomeAdmin/Comunidades/create">Crear nueva</a>
                    </li>
                    <li><a href="form_advanced.html">Adminitrar comunidad</a>
                    </li>
                  </ul>
                </li>
                <li><a><i class="fa fa-user"></i> Usuarios <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="general_elements.html">Crear nuevo</a>
                    </li>
                    <li><a href="media_gallery.html">Administrar</a>
                    </li>
                  </ul>
                </li>
                 <li><a><i class="fa fa-table"></i> Configuraciones <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="/welcomeAdmin/Razas/create">Razas</a>
                    </li>
                    <li><a href="/welcomeAdmin/Razas">Lista de Razas</a>
                    </li>
                  </ul>
                </li>
                <!--
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="{{asset('admin/images/user.png')}}" alt="">jhony Guaman
                ...
                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                  ...
                  <li><a href="/welcomeAdmin"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                  </li>
                </ul>
              </li>
      ...
      @yield('content')
        ...
        <footer>
         <div class="copyright-info">
           <p class="pull-right">Bloopets un sitio para su mascota <a href="http://bloopets.com">Bloopets</a>  
           </p>
         </div>
         <div class="clearfix"></div>
       </footer> 
