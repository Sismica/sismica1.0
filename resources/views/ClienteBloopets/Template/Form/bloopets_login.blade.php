<h1>Bloopets</h1>
        <form id="login" method="post" >
          <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">   
            ...
            <div class="col-md-5">
              {!!Form::text('email',null,['class'=>'form-control text2','placeholder'=>'Correo','required'=>''])!!}
            </div>
            ...
            <div class="col-md-4"></div>
            <div class="col-md-5">
              {!!Form::password('password',['class'=>'form-control text2','placeholder'=>'Contraseña','required'=>''])!!}
            </div>
            <div class="col-md-3"></div>
            </div>
